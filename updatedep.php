        ...
        $officename=$_POST['officename'];
         $depname=$_POST['depname'];         
          $depcode=$_POST['depcode'];
           ...
           $obj -> depupdate($pbsname,$officename,$depname,$depcode,$iprange,$depid);

    }

    while ($dedddata= $depdattaa -> fetch_assoc()):
                        ...
                        <div class="offset-md-3 col-md-6 justify-content-center">
                          ...
                          <div class="card ">
                            <div class="card-body">
                              ...
                              <form action="<?php echo $_SERVER['PHP_SELF'];?>?id=<?php echo $dedddata['id'];?>" method="POST">
                                ...
                                <div class="row mb-3">
                                  ...
                                  <div class="col-sm-9">
                                    <input value="<?php echo $dedddata['depname'];?>" name="depname" class="form-control">
                                  </div>
                                </div>
                                <div class="row mb-3">
                                  <label  for="inputNumber"  class="col-sm-3 col-form-label">Department Code</label>
                                  <div class="col-sm-9">
                                    <input name="depcode" value="<?php echo $dedddata['depcode'];?>"  type="text" placeholder="Admin=1,HR=2,IT=3,O&m=4,e&c=5, ms=6,Fi=7,other=8" class="form-control" required>
                                  </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                  ...
                                  <div class="col-sm-9">
                                    <input name="iprange" value="<?php echo $dedddata['iprange'];?>"  type="text" class="form-control" required>
                                  </div>
                                </div>
